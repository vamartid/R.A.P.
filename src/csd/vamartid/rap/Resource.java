...
public class Resource {
     ...
     * set it's time used value as zero
     * set it's current user-owner value to null
     */
     ...
     * @return
     */
    private void setState(ResourceState new_state){
    ...
    /**
     * get the resource
     * 	set the resource state property to used
     * use	
     * 	increase the number which gives the times a resource was used
     * free
     * 	set the resource state to free i order other costumers can use it
     */
